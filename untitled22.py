...
Original file is located at
    https://colab.research.google.com/drive/1VMVHxKncaywePc-ByAyLdvyXkyTH13RF

# **Analisis Prediksi Data Air Bersih yang Dapat Dikonsumsi Di Masyarakat**
...
"""3.2.2 Distribusi data pada kolom dengan fitur numerik (pH, Hardness Solids, Chloramines, Sulfate, Conductivity, Organic_carbon Trihalomethanes, dan Turbidity)"""
...
"""3.2.3 Distribusi kelas pada kolom dengan fitur kategori (Potability)"""
...
"""**Penutupan**
Model untuk memprediksi data air yang layak di konsumsi oleh manusia telah selesai dibuat dan model ini dapat digunakan untuk memprediksi data yang tepat. Akan Tetapi Ada beberapa pengembangan lain masih dapat digunakan agar akurasinya jadi tepat maka dari itu masih perlu banyak model pengembangan
